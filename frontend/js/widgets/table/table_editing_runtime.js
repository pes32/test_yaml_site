...
const EditingRuntimeMethods = {
    onCellInput(rowIndex, cellIndex, event) {
        ...
        const cells = [...(Utils && Utils.getRowCells ? Utils.getRowCells(rowObject) : [])];
        ...
        tableEngine.log('cell input', dataIndex, cellIndex);
    },
    ...
    onIpInput(rowIndex, cellIndex, event) {
        ...
        tableEngine.log('cell ip input', dataIndex, cellIndex);
    },
    ...
    focusSelectionCellWithRetry(row, col) {
        ...
        this.$nextTick(() => {
            ...
            this.$nextTick(() => {
                if (attempt()) return;
                if (tableEngine && tableEngine.DEBUG) {
                    console.warn(
...
Core.EditingRuntimeMethods = EditingRuntimeMethods;
