...
const SplitButtonWidget = {
    ...
    emits: ['execute'],
    template: `
        <div class="widget-container widget-split-button u-wide"
             :class="{ 'widget-split-button--disabled': !hasActions }">
            <div class="widget-split-button__control"
                 :class="{ show: isDropdownOpen }"
                 :style="controlStyle"
                 ref="controlRoot">
                <div class="widget-button inline-flex-center widget-split-button__primary"
                     :class="buttonClasses"
                     :style="primaryStyle"
                     :title="buttonTitle"
                     aria-hidden="true">
                    ...
                    <span v-if="widgetConfig.label"
                          class="widget-split-button__label"
                ...
                <button ref="toggleButton"
                    ...
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                        ...
                        <path d="M10 9.00002L6.16667 12.8334L5 11.6667L10 6.66669L15 11.6667L13.8333 12.8334L10 9.00002Z"
                              fill="currentColor"/>
                    </svg>
                </button>
            </div>
            ...
            <Teleport to="body">
                <ul ref="dropdownMenu"
                    ...
                    tabindex="-1">
                    <li v-for="(action, index) in displayActions"
                        :key="action.key"
                        role="presentation">
                        <a ref="menuItems"
                           class="dropdown-item"
...
export { SplitButtonWidget };
export default SplitButtonWidget;
