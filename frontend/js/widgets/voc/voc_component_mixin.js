...
import vocModalMixin from './voc_modal_mixin.js';

const vocComponentMixin = {
    mixins: [widgetMixin, vocModalMixin],
    data() {
        return {
            value: '',
            inputValue: '',
...
export { vocComponentMixin };
export default vocComponentMixin;
