    ...
    <div class="page-shell u-wide">
      ...
      <main class="page-content-column u-wide">
        ...
        <div v-if="blockingPageError" class="page-empty-placeholder">
          Не удалось подготовить страницу для отображения. Проверь логи приложения.
        </div>
...
import ErrorPanel from '@frontend/widgets/common/ErrorPanel.vue';
import ItemIcon from '@frontend/widgets/common/ItemIcon.vue';
import ModalManager from '@frontend/widgets/common/ModalManager.vue';
import SectionCard from '@frontend/widgets/common/SectionCard.vue';
import { usePageApp } from '@frontend/page.ts';
