...
Кодовая база сейчас честно остаётся mixed JS/TS: host/runtime glue ещё частично `.js`, а page stores, page view flow и table feature уже вынесены в `.ts`. Это текущая граница миграции, а не обещание полностью strict TypeScript frontend.
